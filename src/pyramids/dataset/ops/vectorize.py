...
def rasterize_features(
    ...
    *,
    ...
    Returns:
        ...
        rather than ``NaN`` — NaN cannot be stored in integer rasters
    ...
    if isinstance(column_name, list):
        ...
        # column without lossy cast. Mixed [int8, float32] → float32,
        # mixed [int8, int16] → int16, etc. Previously the dtype was
...
class Vectorize:
    ...
    def translate(self, path: str | Path | None = None, **kwargs) -> Dataset:
        ...
        result = type(self)(dst, access="write")
        return result
