...
class TestUgridDatasetReadFile:
    ...
    def test_read_western_scheldt(self, western_scheldt_path):
        """Test reading the Western Scheldt UGRID file.
    ...
    def test_mesh_name(self, western_scheldt_path):
        """Test mesh name property.

        Test scenario:
            Western Scheldt mesh is named 'mesh2d'.
        """
        ds = UgridDataset.read_file(western_scheldt_path)
        assert ds.mesh_name == "mesh2d", f"Expected 'mesh2d', got '{ds.mesh_name}'"

    def test_bounds(self, western_scheldt_path):
...
class TestUgridDatasetDataAccess:
    ...
    def test_get_data(self, western_scheldt_path):
    ...
    def test_getitem(self, western_scheldt_path):
    ...
    def test_get_data_invalid_name(self, western_scheldt_path):
    ...
    def test_data_array_shape(self, western_scheldt_path):
...
class TestUgridDatasetProperties:
    ...
    def test_mesh_property(self, western_scheldt_path):
    ...
    def test_global_attributes(self, western_scheldt_path):
    ...
    def test_metadata_property(self, western_scheldt_path):
...
class TestUgridDatasetStringRepr:
    ...
    def test_str(self, western_scheldt_path):
    ...
    def test_repr(self, western_scheldt_path):
