...
def src_masked_cells_center_coords_last4() -> np.ndarray:
    return np.array([[474968.12061706, 474007.78799918],
...
def src_cell_center_coords_first_4_rows() -> np.ndarray:
    return np.array([[434968.12061706, 518007.78799918],
       [434968.12061706, 514007.78799918],
       [434968.12061706, 510007.78799918],
       [434968.12061706, 506007.78799918]])

@pytest.fixture(scope="module")
def src_cell_center_coords_last_4_rows() -> np.ndarray:
    return np.array([[486968.12061706, 482007.78799918],
       [486968.12061706, 478007.78799918],
       [486968.12061706, 474007.78799918],
       [486968.12061706, 470007.78799918]])


@pytest.fixture(scope="module")
def src_cells_corner_coords_last4() -> np.ndarray:
    return np.array([[484968.12061706, 484007.78799918],
       [484968.12061706, 480007.78799918],
       [484968.12061706, 476007.78799918],
